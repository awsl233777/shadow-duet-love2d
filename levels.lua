...
return {
  ...
  },
  {
    name = "02 Door Signal",
    nameZh = "02 门的信号",
    hint = "The gate is too tall to jump. Hold the pad briefly to open it.",
    hintZh = "门太高，跳不过去；短暂踩住按钮打开它",
    start = {x = 54, y = floorY - 30},
    goal = {x = 875, y = floorY - 64, w = 34, h = 64},
    solids = {ground()}, boxes = {},
    buttons = {{id = "b1", x = 500, y = floorY - 10, w = 86, h = 10, target = "d1", hold = 0.6}},
    doors = {gate("d1", 530)},
    lasers = {},
  },
  {
  ...
  },
  {
    name = "10 Relay Locks",
    nameZh = "10 接力门锁",
    hint = "Echo holds the first lock; you must hold the second before the route opens",
    hintZh = "影子守第一道锁，你再守第二道锁，路线才会打开",
    start = {x = 54, y = floorY - 30},
    goal = {x = 875, y = floorY - 64, w = 34, h = 64},
    solids = {ground()},
    boxes = {},
    buttons = {{id = "b1", x = 190, y = floorY - 10, w = 76, h = 10, target = "d1", hold = 1.2}, {id = "b2", x = 520, y = floorY - 10, w = 76, h = 10, target = "d2", hold = 1.2}},
    doors = {gate("d1", 430), gate("d2", 700)},
    lasers = {},
  },
  {
    name = "11 Beam Corridor",
    nameZh = "11 光束走廊",
    hint = "Open the gate with one echo, then pause twice so later echoes dim both beams",
    hintZh = "先用影子开门，再两次停顿，让后续影子压暗两道光束",
    start = {x = 54, y = floorY - 30},
    goal = {x = 875, y = floorY - 64, w = 34, h = 64},
    solids = {ground()},
    boxes = {},
    ...
    doors = {gate("d1", 430)},
    lasers = {beam(625), beam(780)},
  },
  {
    name = "Finale",
    nameZh = "终章",
    hint = "Crate opens one gate, echo opens the second, then chain two beam echoes",
    hintZh = "箱子开第一道门，影子开第二道门，最后连续处理两道光束",
    start = {x = 54, y = floorY - 30},
    goal = {x = 875, y = floorY - 64, w = 34, h = 64},
    solids = {ground()},
    boxes = {box(205)},
